...
if($id!="" and $id>0 and $title!=""){
	...
	$sql_func->delete($query,2,"item_list.php?media_id=".$media_id);
	exit;
}
?>
...
<div class="t_center">图片项目列表</div>
</div>
<div class="bottom">
<form action="item_list_bitop.php?media_id=<?php echo $media_id;?>" method="post" name="form1" onsubmit="return xcheckx()">
<table width="95%" border="1" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<select name="type" onchange="javascript:location.href='item_list.php?media_id='+this.value;">
	  <option value="">选择一种图片分类</option>
	  <?php 
	  	$parm="select `id`,`name` from `".$prefix."media` where `type`='1'";
  ...
  <tr>
    ...
    <td align="center"><input type="text" name="url"  value="<?php echo $info[$i]["url"];?>" class="tt input" title="<?php echo $info[$i]["url"];?>"/></td>
    ...
    <td align="center"><a class="example1" href="item_edit.php?item_id=<?php echo $info[$i]["id"];?>"><img src="<?php echo B_IMG;?>bianji.gif" /></a></td>
    <td align="center"><a href="?id=<?php echo $info[$i]["id"];?>&&media_id=<?php echo $media_id;?>&&title=<?php echo $info[$i]["title"];?>" onclick="return confirm('确定删除？');"><img src="<?php echo B_IMG;?>shanchu.gif" /></a></td>
  </tr>
  <?php 
  	}
  }else{
  ...
  <tr>
    <td colspan="11" align="center" class="red">
		媒体项目为空！<a class="example3" href="item_add-1.php">点击添加新项目</a>
	</td>
  </tr>
  <?php 
  }
