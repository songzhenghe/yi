...
if($id!="" and $id>0 and $title!="" and $pathinfo!=""){
	...
	$sql_func->delete($query,2,"item_list3.php?media_id=".$media_id);
	exit;
}
?>
...
<script>
	...
	$(document).ready(function(){
		$(".example1").colorbox({width:"300px", height:"200px", iframe:true});
...
<div class="t_center">音频项目列表</div>
</div>
<div class="bottom">
<form action="item_list3_bitop.php?media_id=<?php echo $media_id;?>" method="post" name="form1" onsubmit="return xcheckx()">
<table width="95%" border="1" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<select name="type" onchange="javascript:location.href='item_list3.php?media_id='+this.value;">
	  <option value="">选择一种音频分类</option>
	  <?php 
	  	$parm="select `id`,`name` from `".$prefix."media` where `type`='3'";
  ...
  <tr>
    ...
    <td align="center">
	<a class="example1" href="dewplayer.php?item_id=<?php echo $info[$i]["id"];?>"><img src="<?php echo B_IMG;?>watch.gif" /></a>
	</td>
    ...
    <td align="center"><a class="example2" href="item_edit3.php?item_id=<?php echo $info[$i]["id"];?>"><img src="<?php echo B_IMG;?>bianji.gif" /></a></td>
  ...
  <tr>
    <td colspan="11" align="center" class="red">
		媒体项目为空！<a class="example3" href="item_add-3.php">点击添加新项目</a>
	</td>
  </tr>
  <?php 
  }
