...
<div id="container">
    ...
    <div id="content">
		...
		?>
                <li><em>[<?php echo $sql_func->id2name($prefix,$info[$i]["add_man"]);?>&nbsp;&nbsp;<?php echo substr($info[$i]["add_time"],0,10);?>]</em><a href="v_content.php?id=<?php echo $info[$i]["id"];?>" title="<?php echo $info[$i]["alt"]?>"><?php echo $common_func->substrs($info[$i]["alt"],70);?></a></li>
		<?php 
           		}
        ?>
		  <?php
